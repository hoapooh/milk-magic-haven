...
export default function ManageOrder() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://localhost:8000/staff/get-all-order');
                if (!response.ok) {
        ...
        <Box display="flex" justifyContent="center" mt={20} ml={-30} mr={15}>
            <TableContainer component={Paper} sx={{ width: '100%', mx: 'auto', mt: 0.5 }}>
                <Table sx={{ minWidth: 1000, fontSize: '1.2rem' }} aria-label="custom pagination table">
                    <TableHead>
                        <TableRow>
                            <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Order ID</TableCell>
                            <TableCell align="center" sx={{ fontSize: '1.2rem' }}>User ID</TableCell>
                            <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Order Date</TableCell>
                            <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Status</TableCell>
                            <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Total</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {(rowsPerPage > 0
