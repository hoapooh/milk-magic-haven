...
export default function ManageProduct() {
  ...
  return (
    <Box display="flex" justifyContent="center" mt={20} ml={-35} mr={9}>
      <TableContainer component={Paper} sx={{ width: '100%', mx: 'auto', mt: 0.5 }}>
        <Table sx={{ minWidth: 1000, fontSize: '1.2rem' }} aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Post ID</TableCell>
              <TableCell align="center" sx={{ fontSize: '1.2rem' }}>User ID</TableCell>
              <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Content</TableCell>
              <TableCell align="center" sx={{ fontSize: '1.2rem' }}>Post Date</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {(rowsPerPage > 0
