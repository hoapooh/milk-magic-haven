			...
			<ThemeProvider theme={theme}>
				<Grid container spacing={4} mt={5}>
					...
					<Grid item md={6} sx={{ maxHeight: "400px" }}>
						<div className="banner">
							<img
								src="https://s3-alpha-sig.figma.com/img/4092/8e39/b8bbe162327a7a85b43c1bb61fa6ce6b?Expires=1719187200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ON9PxmByoEtRM3~i2~MQbHOCwce8W60XjqgWhCUy9o3YENIh3-mA1o-SFL6haN2n8P0c87FAMppEFzckXFU2s7Nex~zJnZrEDJXYWct6WreeX7zbdIImrffBe-L86cEyCiRua7pVuc8eHxbffNIiOhM1rFyIsjFTzRCGtzrltIVa9Y-izOXiieCGKMGAbDSTENYjky-jdnUlu6XG87HfeW8w70WCqAv~IgGmPDsE4J9ahuJ2~F7FfsG1MsJuJTpbsVqY1D8UTROHTnszhCPt3MsfORzfrpRgsiw9BsJYPeSryaOU1LyRO0M6WP14Fa29DmSSyuz-o7u9DOAfWLimiw__"
								alt="adv"
							/>
						</div>
