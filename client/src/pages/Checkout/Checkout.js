    ...
    try {
      const data = await fetch(`${MainAPI}/user/order`, {
        ...
        body: JSON.stringify({
          ...
          user_id: JSON.parse(localStorage.getItem("username")).user_id,
          total_amount: total,
      ...
      if (data.status === 200) {
        ...
        toast.error("Thanh toán thất bại! Vui lòng kiểm tra lại thông tin.", {
          position: "top-right",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
            ...
            <Grid container spacing={4} mt={2}>
              <Grid item xs={12} md={7}>
                ...
                <form onSubmit={formik.handleSubmit} className="checkout__form">
                  <h2 className="checkout__form__title">Thông tin cá nhân</h2>
              ...
              <Grid item xs={12} md={5}>
                <Box className="checkout__order">
                  <h2 className="checkout__order__title">Thông tin đặt hàng</h2>
                  {/* ====== ORDER ITEM ====== */}
                  {cartList.map((product, item) => (
                    <Box className="checkout__order__item" key={item}>
                  ...
                  <Box className="checkout__order__total">
                    ...
                    >
                      ...
                      >
                        {`${(Number(total) || 0).toLocaleString("vi-VN")} VND`}
                      </Box>
                    </div>
                  </Box>
                </Box>
