        ...
        <Grid item md={10}>
          <div className="StatisticProduct_content">
            <div className="StatisticProduct_pie">
              <h1>Biểu đồ tròn thống kê số sản phẩm trong từng thể loại</h1>
              <Pie data={brandPieData} />
            </div>
            <div className="StatisticProduct_bar">
              <h1>Biểu đồ cột thống kê những sản phẩm bán chạy</h1>
              <Bar data={topProductBarData} options={barOptions} />
            </div>
          </div>
        </Grid>
      </Grid>
