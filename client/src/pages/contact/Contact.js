...
function Contact() {
  const baseURL = `http://localhost:8000/user/send-contact`;
  ...
  const submit = async (values) => {
    try {
      ...
      console.log(error);
      toast.error("An error occurred while sending the contact message.");
    }
  };
        ...
        <div className="contact">
          ...
          <div className="contact_content">
            ...
            <div className="contact_content_right">
              <div className="contact_content_right_header">Liên hệ với chúng tôi</div>
