            ...
            <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                {listLoves.map((love, index) => (
                    <Grid item md={3} key={index}>
                        ...
                        <div>
                            <div><p style={{ fontSize: '20px' }}>{love.name}</p></div>
                            <div>
                                {love.reprice !== undefined &&
                                    <div>
                                        ...
                                        <span style={{ textDecoration: "line-through", fontSize: '12px', color: '#9d9999' }}>{love.price}</span>
                                    </div>
                                }
                                {love.reprice === undefined &&
                                    <span style={{ fontSize: '15px' }}>{love.price}</span>
                                }
                            </div>

                            <div style={{ color: 'orange', fontSize: '20px' }}>{love.rate}</div>
                        </div>
                    </Grid>
                ))}
            </Grid>
